...
public class BD {
 private static final Logger logger= Logger.getLogger(BD.class);
    ...
    private static final String SQL_PRUEBA_ODONTOLOGOS="INSERT INTO ODONTOLOGOS (NUMERO_MATRICULA, NOMBRE, APELLIDO) VALUES(12345, 'MARCO', 'POLO'), " +
            "(1234567, 'MANUEL', 'PEREZ'), (43215, 'MARIA', 'CASAS')";
